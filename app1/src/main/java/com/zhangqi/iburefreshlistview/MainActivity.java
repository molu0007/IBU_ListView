...
public class MainActivity extends Activity implements IbuListView.OnMeiTuanRefreshListener {
	private IbuListView mListView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView = (IbuListView) findViewById(R.id.listview);
